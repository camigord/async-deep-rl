...
#       action_index = np.random.choice(range(self.num_actions), p=network_output_pi)
    ...
    def _run(self):
        ...
        while (self.global_step.value() < self.max_global_steps):
            ...
            if episode_over:
                ...
                R = self.session.run(self.local_network.output_layer_v,feed_dict={self.local_network.input_ph:[new_s]})[0][0]
